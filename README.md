...
4. **A way to reach you** — most of the time, sessions will stop quietly and unless you're already in cowork then you can be notified later. But if something is actually urgent, it reaches you right away — Discord, text, Slack, whatever you use, to go back and answer the question in cowork with AskUserQuestion.
